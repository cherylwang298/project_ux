<?php
/* ============================================
   AGODA REDESIGN — _head.php
   Pastel Mint-Lavender Theme
   ============================================ */

$font = '<link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=DM+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet">';
$css  = '<link rel="stylesheet" href="assets/style.css">';

/* Blob background decoration shared across pages */
$blobs = '<div class="bg-blob bg-blob-1"></div><div class="bg-blob bg-blob-2"></div>';

function nav($active=''){
  $pages=[
    'index'  =>['Beranda', '<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>', 'index.php'],
  ...
  foreach($pages as $k=>$v){
    ...
    $html.='<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">'.$v[1].'</svg>';
