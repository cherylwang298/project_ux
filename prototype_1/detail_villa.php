              ...
              <div class="space-y-3 mb-5">
                ...
                <div>
                  ...
                  <div class="h-11 px-3 rounded-xl bg-surface-container-low border border-outline-variant flex items-center justify-between">
                    <button type="button" onclick="changeGuests(-1)" class="w-8 h-8 rounded-full bg-white/80 border border-outline-variant/40 hover:bg-secondary hover:text-white transition-all flex items-center justify-center"><span class="w-3.5 h-0.5 bg-current rounded-full block"></span></button>
                    ...
                    <button type="button" onclick="changeGuests(1)" class="w-8 h-8 rounded-full bg-white/80 border border-outline-variant/40 hover:bg-secondary hover:text-white transition-all flex items-center justify-center relative"><span class="w-3.5 h-0.5 bg-current rounded-full block absolute"></span><span class="w-0.5 h-3.5 bg-current rounded-full block absolute"></span></button>
                    </div>
