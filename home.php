...
.hero-search{width:min(1120px,calc(100vw - 40px));margin:0 auto;display:grid;grid-template-columns:1.1fr 1fr 1fr .85fr 82px;align-items:center;min-height:86px;border-radius:24px;background:rgba(255,255,255,.62);backdrop-filter:blur(30px);-webkit-backdrop-filter:blur(30px);border:1px solid rgba(255,255,255,.72);box-shadow:0 24px 80px -32px rgba(17,28,45,.32), inset 0 1px 0 rgba(255,255,255,.85);overflow:hidden}
...
.tab-btn{transition:all .25s ease}.tab-btn.active{background:#004ce2;color:#fff;box-shadow:0 4px 12px rgba(0,76,226,.3)}
@media(max-width:900px){.hero-search{grid-template-columns:1fr;gap:0;padding:10px}.search-cell{border-right:0;border-bottom:1px solid rgba(120,130,155,.12);min-height:72px}.search-btn{width:100%;border-radius:18px;margin-top:8px}.hero-content{padding-left:20px;padding-right:20px}}
CSS
);
?>
...
<section class="hero-clean">
  ...
  <div class="hero-content">
    ...
    <form action="detail_hotel.php" method="GET" class="hero-search">
